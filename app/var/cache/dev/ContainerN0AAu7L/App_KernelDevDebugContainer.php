...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\AgendaSlotPatternCrudController' => 'getAgendaSlotPatternCrudControllerService',
            ...
            'App\\Controller\\Admin\\UtilisateursCrudController' => 'getUtilisateursCrudControllerService',
            'App\\Controller\\Admin\\WikiPage2CrudController' => 'getWikiPage2CrudControllerService',
            'App\\Controller\\Admin\\WikiPageCrudController' => 'getWikiPageCrudControllerService',
            'App\\Controller\\AgendaBookingController' => 'getAgendaBookingControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\LocationAttachController' => 'getLocationAttachControllerService',
    ...
    {
        return $container->services['cache.easyadmin'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0maTvPyhCO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('CalendarBundle\\Event\\SetDataEvent', [#[\Closure(name: 'App\\EventSubscriber\\WikiCalendarSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\WikiCalendarSubscriber'] ?? $container->load('getWikiCalendarSubscriberService')), 'onCalendarSetData'], 0);
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $f = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry(['App\\Controller\\Admin\\AgendaCrudController' => 'App\\Entity\\Agenda', 'App\\Controller\\Admin\\AgendaSlotPatternCrudController' => 'App\\Entity\\AgendaSlotPattern', 'App\\Controller\\Admin\\ArticleCrudController' => 'App\\Entity\\Article', 'App\\Controller\\Admin\\UtilisateursCrudController' => 'App\\Entity\\Utilisateurs', 'App\\Controller\\Admin\\WikiPage2CrudController' => 'App\\Entity\\WikiPage', 'App\\Controller\\Admin\\WikiPageCrudController' => 'App\\Entity\\WikiPage'], ['App\\Controller\\Admin\\AgendaCrudController' => '114fa5f', 'App\\Controller\\Admin\\AgendaSlotPatternCrudController' => 'fc2f2f0', 'App\\Controller\\Admin\\ArticleCrudController' => '5e0da09', 'App\\Controller\\Admin\\UtilisateursCrudController' => '49245a3', 'App\\Controller\\Admin\\WikiPage2CrudController' => '21170e6', 'App\\Controller\\Admin\\WikiPageCrudController' => 'a1c5b7f'], ['App\\Entity\\Agenda' => 'App\\Controller\\Admin\\AgendaCrudController', 'App\\Entity\\AgendaSlotPattern' => 'App\\Controller\\Admin\\AgendaSlotPatternCrudController', 'App\\Entity\\Article' => 'App\\Controller\\Admin\\ArticleCrudController', 'App\\Entity\\Utilisateurs' => 'App\\Controller\\Admin\\UtilisateursCrudController', 'App\\Entity\\WikiPage' => 'App\\Controller\\Admin\\WikiPageCrudController'], ['114fa5f' => 'App\\Controller\\Admin\\AgendaCrudController', 'fc2f2f0' => 'App\\Controller\\Admin\\AgendaSlotPatternCrudController', '5e0da09' => 'App\\Controller\\Admin\\ArticleCrudController', '49245a3' => 'App\\Controller\\Admin\\UtilisateursCrudController', '21170e6' => 'App\\Controller\\Admin\\WikiPage2CrudController', 'a1c5b7f' => 'App\\Controller\\Admin\\WikiPageCrudController']);

        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'] = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\AdminRouterSubscriber(new \EasyCorp\Bundle\EasyAdminBundle\Factory\AdminContextFactory($container->targetDir.'', ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Factory\MenuFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Security\\AuthorizationChecker'] ?? self::getAuthorizationCheckerService($container)), $a, (isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Menu\MenuItemMatcher((isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), $b), $c), $f, $d, $b, $e), ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\ControllerFactory'] ?? self::getControllerFactoryService($container)), ($container->privates['debug.controller_resolver'] ?? self::getDebug_ControllerResolverService($container)), $c, $c, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), $b, $container->targetDir.'', $f);
    }
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            ...
            yield 0 => ($container->services['App\\Controller\\Admin\\AgendaCrudController'] ?? $container->load('getAgendaCrudControllerService'));
            yield 1 => ($container->services['App\\Controller\\Admin\\AgendaSlotPatternCrudController'] ?? $container->load('getAgendaSlotPatternCrudControllerService'));
            yield 2 => ($container->services['App\\Controller\\Admin\\ArticleCrudController'] ?? $container->load('getArticleCrudControllerService'));
            yield 3 => ($container->services['App\\Controller\\Admin\\UtilisateursCrudController'] ?? $container->load('getUtilisateursCrudControllerService'));
            yield 4 => ($container->services['App\\Controller\\Admin\\WikiPage2CrudController'] ?? $container->load('getWikiPage2CrudControllerService'));
            yield 5 => ($container->services['App\\Controller\\Admin\\WikiPageCrudController'] ?? $container->load('getWikiPageCrudControllerService'));
        }, 6), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en', new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
    ...
    protected static function getAdminUrlGeneratorService($container)
    {
        $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] = function ($container) {
            ...
            return new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $a, ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\DashboardControllerRegistry'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Registry\DashboardControllerRegistry($container->targetDir.'', ['App\\Controller\\Admin\\DashboardController' => '65799dd'], ['65799dd' => 'App\\Controller\\Admin\\DashboardController'])), $b, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)));
        };
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/symfony/ux-live-component/src/DependencyInjection/../../assets/dist') => '@symfony/ux-live-component', (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', 'assets/' => '', (\dirname(__DIR__, 4).'/vendor/easycorp/easyadmin-bundle/public') => 'bundles/easyadmin'], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j4xdxQbGDO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\AgendaCrudController', 'App\\Controller\\Admin\\AgendaSlotPatternCrudController', 'App\\Controller\\Admin\\ArticleCrudController', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\Admin\\UtilisateursCrudController', 'App\\Controller\\Admin\\WikiPage2CrudController', 'App\\Controller\\Admin\\WikiPageCrudController', 'App\\Controller\\AgendaBookingController', 'App\\Controller\\HomeController', 'App\\Controller\\LocationAttachController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'App\\Controller\\TagController', 'App\\Controller\\UserController', 'App\\Controller\\WikiController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
