...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['App\\Security\\AuthentificatorAuthenticator'] ?? $container->load('getAuthentificatorAuthenticatorService'));
